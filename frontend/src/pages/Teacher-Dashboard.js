...
const TeacherDashboard = ({}) => {
   ...
   const fetchTeacher = async () => {
      await fetch('http://127.0.0.1:5001/miami-hackathon-ai/us-central1/api/teacher/EI0963XnsOV9xd5ivXsa')
      ...
      <Box sx={{ paddingLeft: 3, paddingRight: 3 }}>
         ...
         <SwipeableDrawer open={openDrawer}>
            <div className='teacher-dashbaord-container'>
               <Avatar alt='profile image' src='https://media.istockphoto.com/id/1338134319/photo/portrait-of-young-indian-businesswoman-or-school-teacher-pose-indoors.jpg?s=612x612&w=0&k=20&c=Dw1nKFtnU_Bfm2I3OPQxBmSKe9NtSzux6bHqa9lVZ7A=' sx={{ height: 75, width: 75 }} />
               <div className='teacher-dashbaord-container__button-items'>
                  <Button >Home</Button>
                  <Button>Students</Button>
                  <Button>Questions</Button>
                  <Button className='teacher-dashbaord-container__button-items__signout' color='error' variant="contained">Sign out</Button>
               </div>
            </div>
         </SwipeableDrawer>
         ...
         <div className='teacher-dashboard-content'>
            ...
            <div className='teacher-dashboard-content__items'>
               <div className='teacher-dashboard-content__student-roster'>
                  ...
                  { teacherDashboardData?.students && teacherDashboardData.students.map((student, index) => {
                     ...
                     return(
                        <div className='teacher-dashboard-content__student-roster__item'>
                           <div className='teacher-dashboard-content__student-roster__item__userInfo'>
                              <Avatar sx={{ height: 55, width: 55 }} src={student.photoUrl} />
                              <h4>{student.displayName}</h4>
                              {student.questions.map((question, index) => {

                                 let uniqueChars = student.questions.filter((quest, index) => {
                                       return student.questions.indexOf(quest.topic) === index;
                                 });
                           ...
                           <Button variant='outlined' color='error' sx={{ height: 34 }} onClick={() => setStudentData(student)}>View Questions</Button>
                        </div>
                     )
                  })}
               </div>
                  ...
                  <div className='dashboard__low-improving-subjects'>
                     <div className='dashboard__low-improving-subjects__item'>
                        <div className='dashboard__low-improving-subjects__item__left'>
                           ...
                           <h2 style={{ fontSize: 16 , marginBottom: 6 }}>Real Life Questions</h2>
                           <u><h5 style={{ color: '#77A52D', fontSize: 18, marginBottom: 6  }}>Specific Topics</h5></u>
                        ...
                        <div className='dashboard__low-improving-subjects__item__right'>
                           ...
                           <h1 style={{ color: '#FD0404', fontSize: 40, fontWeight: 'bolder' }}>{scienceCounter} Questions</h1>
                     ...
                     <div className='dashboard__low-improving-subjects__item'>
                        ...
                        <div className='dashboard__low-improving-subjects__item__right'>
                           <h3 style={{ fontSize: 24 }}>More Resources</h3>
                           <h1 style={{ color: '#FD0404', fontSize: 40, fontWeight: 'bolder' }}>{historyCounter} Questions</h1>
                           {/* <Doughnut 
                              data={{
                                 datasets: [{
                     ...
                     <div className='dashboard__low-improving-subjects__item'>
                        ...
                        <div className='dashboard__low-improving-subjects__item__right'>
                           <h3 style={{ fontSize: 24 }}>More Resources</h3>
                           <h1 style={{ color: '#FD0404', fontSize: 40, fontWeight: 'bolder' }}>{mathCounter.counter} Questions</h1>
                           <h5>View More Details</h5>
                        </div>
                     </div>
                  </div>
         ...
         { studentData && 
            <>
               <div className='teacher-dashboard-content__student-questions' style={{ marginTop: 10, background: 'transparent', borderWidth: 2, borderColor: '#9797971A', borderStyle: 'solid' }}>
                        ...
                        <>
                           <div className='teacher-dashboard-content__student-question__item'>
                              ...
                              <div className='teacher-dashboard-content__student-question__userInfo'>
                                 <div className='teacher-dashboard-content__student-roster__item' style={{ padding: 0 }}>
                                    <div className='teacher-dashboard-content__student-roster__item__userInfo'>
                                       <Avatar sx={{ height: 55, width: 55 }} src={studentData.photoUrl} />
                                    </div>
                                 </div>
                              </div>
